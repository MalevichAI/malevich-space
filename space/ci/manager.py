import space.schema as schema
import space.constants as constants

from space.ops.service import BaseService
from space.ops.component_provider import BaseComponentProvider
from space.parser import YAMLParser
...
class CIManager:
    ...
    def _report_ci_reverse_id(self, reverse_id: str, report: CIReport):
        ...
        if not branch:
            ...
            branch = branch.uid
        version_id = self.space.create_version(
            branch_id=branch,
